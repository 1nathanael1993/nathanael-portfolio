...
export default function BentoGrid() {
  return (
    <section id="projects" className="relative py-32 px-4 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-12 group relative rounded-2xl overflow-hidden bg-gradient-to-r from-neon-blue/10 to-neon-violet/10 border border-white/5 p-12 text-center"
          >
            <div className="absolute inset-0 bg-black/40 backdrop-blur-xl -z-10" />
            <h3 className="text-3xl font-bold mb-4 text-white">¿Tienes un proyecto en mente?</h3>
